package com.example.brainitreeimpolimentation;
...
public class MainActivity extends AppCompatActivity {
    ...
    final String get_token = "https://magiceight.000webhostapp.com/main.php";
    final String send_payment_details = "https://magiceight.000webhostapp.com/checkout.php";
    String token, amount;
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        if(response.contains("Successful"))
                        {
                            ...
                            Toast.makeText(MainActivity.this, "Transaction successful"+response, Toast.LENGTH_LONG).show();
                        }
            ...
            client.get(get_token, new HttpResponseCallback() {
                ...
                public void success(final String responseBody) {
                    ...
                    runOnUiThread(new Runnable() {
                        @Override
                        public void run() {
                            Toast.makeText(MainActivity.this, "Successfully got token \n "+responseBody, Toast.LENGTH_SHORT).show();
